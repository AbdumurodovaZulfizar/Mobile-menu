...
```
git clone https://github.com/AbdumurodovaZulfizar/Mobile-menu.git
```
...
- If you want to see live version of this project on your local machine install Live Server extension
## Authors
...
- [MIT LICENSE](https://github.com/AbdumurodovaZulfizar/Mobile-menu/blob/mobile_menu/MIT.md) for this project.